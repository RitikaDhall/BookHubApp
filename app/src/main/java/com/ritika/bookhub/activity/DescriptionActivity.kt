package com.ritika.bookhub.activity
...
import com.ritika.bookhub.R
import com.ritika.bookhub.database.BookDatabase
import com.ritika.bookhub.database.BookEntity
import com.ritika.bookhub.util.ConnectionManager
...
class DescriptionActivity : AppCompatActivity() {
                            ...
                            btnAddToFav.setOnClickListener {
                                ...
                                if (!DBAsyncTask(applicationContext, bookEntity, 1).execute().get()) {
                                    ...
                                    if (result) {
                                        ...
                                        btnAddToFav.text = "Add to favourites"
                                        val noFavColor = ContextCompat.getColor(applicationContext, R.color.colorFavorite)
                                        btnAddToFav.setBackgroundColor(noFavColor)
                                    } else {
                                        Toast.makeText(
                                            this@DescriptionActivity,
    ...
    class DBAsyncTask(val context: Context, val bookEntity: BookEntity, val mode: Int): AsyncTask<Void, Void, Boolean>() {
        ...
        /*
        Mode 1 -> Check DB if the book if favourite or not
